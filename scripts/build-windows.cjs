...
console.log('🚀 Building SellX Desktop for Windows...\n');
...
async function main() {
  try {
    ...
    console.log('🎯 Starting Windows desktop build process...\n');
    
    // Step 1: Clean previous builds
    execCommand('npm run clean', 'Cleaning previous builds');
    
    // Step 2: Build React renderer for desktop
    ...
    execCommand('npx electron-builder --win', 'Building Windows installer');
    
    // Step 5: List output files
    listOutputFiles();
    
    console.log('🎉 Windows desktop build completed successfully!');
    console.log('\n📋 Next Steps:');
