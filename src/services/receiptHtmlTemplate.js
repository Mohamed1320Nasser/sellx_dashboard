...
exports.saleToReceiptData = saleToReceiptData;
const qrcode_1 = __importDefault(require("qrcode"));
async function generateReceiptHTML(data) {
    const { orderId, orderDate, companyName, companyAddress, companyPhone, companyTaxId, companyLogo, cashierName, items, subtotal, discount = 0, taxRate = 0, taxAmount = 0, additionalFee = 0, additionalFeeLabel = '', total, paid = 0, change = 0, paperWidth = '80mm', showLogo = false, showOrderId = true, showTaxBreakdown = true, showQRCode = false, headerText = '', footerText = 'شكراً لزيارتكم', } = data;
    let qrCodeDataUrl = '';
    if (showQRCode) {
        try {
            const qrData = [
            ...
            qrCodeDataUrl = await qrcode_1.default.toDataURL(qrData, {
                width: 150,
                margin: 1,
...
function saleToReceiptData(params) {
