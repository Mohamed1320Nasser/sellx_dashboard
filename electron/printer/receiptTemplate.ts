/**
 * Professional Receipt HTML Template for Electron
 *
 * This is a copy of the template from src/services/receiptHtmlTemplate.ts
 * kept in electron folder to avoid TypeScript compilation issues.
 *
